...
import gameSpiritsRoutes from './routes/game-spirits.routes.js'
...
// Game data: catalogo de ninjas + espíritus animales (publico, sin auth)
app.use('/game/ninjas', gameNinjasRoutes)
app.use('/game/spirits', gameSpiritsRoutes)
